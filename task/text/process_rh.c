/**
 * process_rh.c -- реализует функцию удаления первой строки в тексте
 *
    ...
    )
{
    ...
    /*Присваиваем a указатель на вторую строку текста*/
    node *a=txt -> begin -> next;
    /*Удаляем первую строку*/
    free(txt->begin);
    /*Присваеваем а указатель на начало текста*/
    txt->begin=a;
}
